    ...
    UINT type, GHOST_WindowWin32 *window, WPARAM wParam, LPARAM lParam, bool &eventHandled)
{
  ...
  // The window stored tabletdata is used to ensure WM_MOUSEMOVE events generated by SetCursorPos
  // do not trigger additional GHOST_EventCursor events, thus window->setTabletData is necessary.
  switch (type) {
